CRUMINA.Bootstrap = function() {
    $('[data-toggle="tooltip"], [rel="tooltip"]').tooltip(), $('[data-toggle="popover"]').popover();
...
}), CRUMINA.rangeSlider = function() {}, $(document).ready(function() { CRUMINA.rangeSlider() }), CRUMINA.IsotopeSort = function() {
...
$(document).ready(function() {
    ...
    $(".swiper-container").each(function() {
        ...
        var n = a.data("effect") ? a.data("effect") : "slide",
            ...
            d = a.data("direction") ? a.data("direction") : "horizontal",
            c = !!a.data("mouse-scroll") && a.data("mouse-scroll"),
